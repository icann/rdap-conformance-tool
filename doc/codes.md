...
- `-46900`: Domain status combination not compliant with RFC 5731 - "The values of the status data structure does not comply with RFC5731." Validates EPP status combinations, including: (a) "active" must not be combined with "inactive", "client hold", "client renew prohibited", "client delete prohibited", "client transfer prohibited", "client update prohibited", "server hold", "server renew prohibited", "server delete prohibited", "server transfer prohibited", "server update prohibited", "pending create", "pending renew", "pending update", "pending delete" or "pending transfer"; (b) "pending delete" must not be combined with "client delete prohibited" or "server delete prohibited"; (c) "pending renew" must not be combined with "client renew prohibited" or "server renew prohibited"; (d) "pending transfer" must not be combined with "client transfer prohibited" or "server transfer prohibited"; (e) "pending update" must not be combined with "client update prohibited" or "server update prohibited"; (f) at most one "pending create/delete/renew/transfer/update" status may be present; and (g) "redemption period" and "pending restore" must not be combined with each other. [RFC 5731 EPP Domain Mapping] {ResponseValidationRFC5731.java}
...
- `-62004`: Redacted string members validation (2024 profile) - "The members 'postPath', 'pathLang', 'prePath', 'replacementPath', and 'method' must be strings." [RFC 9537, RDAP Response Profile 2024] {ResponseValidation1Dot2_6_2024.java}
- `-62005`: Redacted reason member validation (2024 profile) - "The 'reason' member is an object and may only contain the optional string 'lang', 'type', and 'description'." [RFC 9537, RDAP Response Profile 2024] {ResponseValidation1Dot2_7_2024.java}
...
- `-65803`: Registrant Organization redaction description warning (2024 profile) - "A redaction object with a description of Registrant Organization exists. This warning may be ignored if the redaction should not use the 'type' property." [RFC 9537, RDAP Response Profile 2024] {ResponseValidationRedactionDescriptionWarning.java} ⚠️ WARNING
- `-65804`: Registrant Street redaction description warning (2024 profile) - "A redaction object with a description of Registrant Street exists. This warning may be ignored if the redaction should not use the 'type' property." [RFC 9537, RDAP Response Profile 2024] {ResponseValidationRedactionDescriptionWarning.java} ⚠️ WARNING
- `-65805`: Registrant City redaction description warning (2024 profile) - "A redaction object with a description of Registrant City exists. This warning may be ignored if the redaction should not use the 'type' property." [RFC 9537, RDAP Response Profile 2024] {ResponseValidationRedactionDescriptionWarning.java} ⚠️ WARNING
- `-65806`: Registrant Postal Code redaction description warning (2024 profile) - "A redaction object with a description of Registrant Postal Code exists. This warning may be ignored if the redaction should not use the 'type' property." [RFC 9537, RDAP Response Profile 2024] {ResponseValidationRedactionDescriptionWarning.java} ⚠️ WARNING
- `-65807`: Registrant Phone redaction description warning (2024 profile) - "A redaction object with a description of Registrant Phone exists. This warning may be ignored if the redaction should not use the 'type' property." [RFC 9537, RDAP Response Profile 2024] {ResponseValidationRedactionDescriptionWarning.java} ⚠️ WARNING
- `-65808`: Registrant Phone Ext redaction description warning (2024 profile) - "A redaction object with a description of Registrant Phone Ext exists. This warning may be ignored if the redaction should not use the 'type' property." [RFC 9537, RDAP Response Profile 2024] {ResponseValidationRedactionDescriptionWarning.java} ⚠️ WARNING
- `-65809`: Registrant Fax redaction description warning (2024 profile) - "A redaction object with a description of Registrant Fax exists. This warning may be ignored if the redaction should not use the 'type' property." [RFC 9537, RDAP Response Profile 2024] {ResponseValidationRedactionDescriptionWarning.java} ⚠️ WARNING
- `-65810`: Registrant Fax Ext redaction description warning (2024 profile) - "A redaction object with a description of Registrant Fax Ext exists. This warning may be ignored if the redaction should not use the 'type' property." [RFC 9537, RDAP Response Profile 2024] {ResponseValidationRedactionDescriptionWarning.java} ⚠️ WARNING
- `-65811`: Registrant Email redaction description warning (2024 profile) - "A redaction object with a description of Registrant Email exists. This warning may be ignored if the redaction should not use the 'type' property." [RFC 9537, RDAP Response Profile 2024] {ResponseValidationRedactionDescriptionWarning.java} ⚠️ WARNING

...
- `-65802`: Registrant Name redaction description warning (2024 profile) - "A redaction object with a description of Registrant Name exists. This warning may be ignored if the redaction is should not use the 'type' property." {ResponseValidationRedactionDescriptionWarning.java} ⚠️ WARNING

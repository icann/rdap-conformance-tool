...
- `-65805`: Registrant City redaction description warning (2024 profile) - "A redaction object with a description of Registrant City exists. This warning may be ignored if the redaction is should not use the 'type' property." [RFC 9537, RDAP Response Profile 2024] {ResponseValidationRedactionDescriptionWarning.java} ⚠️ WARNING

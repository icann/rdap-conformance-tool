...
public class RDAPValidator implements ValidatorWorkflow {
    ...
    private List<ProfileValidation> get2024ProfileValidations(HttpResponse<String> rdapResponse,
        ...
        validations.add(new ResponseValidation2Dot2_1_2024(rdapResponseData, results, datasetService, queryType));
        ...
        validations.add(new ResponseValidationRegistrantHandle_2024(config, rdapResponseData, results, datasetService, queryType));
        ...
        validations.add(new ResponseValidation2Dot6Dot3_2024(rdapResponseData, results, config, queryType));
        validations.add(new ResponseValidation2Dot10_2024(rdapResponseData, results, config, queryType));

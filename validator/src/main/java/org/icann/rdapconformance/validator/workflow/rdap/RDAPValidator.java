...
public class RDAPValidator implements ValidatorWorkflow {
    ...
    private List<ProfileValidation> get2024ProfileValidations(HttpResponse<String> rdapResponse,
        ...
        validations.add(new TigValidation4Dot1(rdapResponseData, results, config));
        validations.add(new TigValidation7Dot1And7Dot2(rdapResponseData, results, config));
        validations.add(new ResponseValidation1Dot2Dot2(rdapResponseData, results, config));
        validations.add(new ResponseValidation1Dot4(rdapResponseData, results, config));
        validations.add(new ResponseValidationLastUpdateEvent(rdapResponseData, results, config, queryType));
        validations.add(new ResponseValidation2Dot1(rdapResponseData, results, config, queryType));
        validations.add(new ResponseValidation2Dot3Dot1Dot1(rdapResponseData, results, config, queryType));
        validations.add(new ResponseValidation2Dot3Dot1Dot2(rdapResponseData, results,  config, queryType));
        validations.add(new ResponseValidation2Dot3Dot2_2024(rdapResponseData, results, config, queryType));
        validations.add(new ResponseValidation2Dot10(rdapResponseData, results, config, queryType));
        validations.add(new ResponseValidationRFC5731(rdapResponseData, results, config, queryType));
        validations.add(new ResponseValidationRFC3915(rdapResponseData, results,config, queryType));
        validations.add(new ResponseValidation2Dot6Dot1(rdapResponseData, results, config, queryType));
        validations.add(new ResponseValidation2Dot9Dot1And2Dot9Dot2(config, rdapResponseData, results, datasetService, queryType));
        validations.add(new ResponseValidation2Dot4Dot1(rdapResponseData, results, config, queryType));
        validations.add(new ResponseValidation2Dot4Dot2And2Dot4Dot3(rdapResponseData, results, datasetService, config, queryType));
        validations.add(new ResponseValidation2Dot4Dot5(rdapResponseData, results, config, queryType));
        ...
        validations.add(new ResponseValidation4Dot3(rdapResponseData, results, config, datasetService, queryType));
        ...
        validations.add(new ResponseValidation1Dot2_2_2024(rdapResponseData, results, config));
        validations.add(new ResponseValidation2Dot2_2024(rdapResponseData, results, config, queryType));
        validations.add(new ResponseValidation2Dot2_1_2024(rdapResponseData, results, config, datasetService));
        ...
        validations.add(new ResponseValidation2Dot7Dot5Dot1_2024(rdapResponseData, results, config));
        validations.add(new ResponseValidation2Dot7Dot5Dot2_2024(rdapResponseData, results, config));
        validations.add(new ResponseValidation2Dot7Dot5Dot3_2024(rdapResponseData, results, config));
        validations.add(new ResponseValidation2Dot7Dot6Dot2_2024(rdapResponseData, results, config));
        validations.add(new ResponseValidation2Dot7Dot6Dot3_2024(rdapResponseData, results, config));
        validations.add(new ResponseValidation2Dot9Dot1And2Dot9Dot2_2024(rdapResponseData, results, config, queryType));
        validations.add(new ResponseValidation4Dot1Handle_2024(rdapResponseData, results, config, queryType));
        validations.add(new ResponseValidationRegistrantHandle_2024(rdapResponseData, results, config, datasetService));
        validations.add(new ResponseValidationLinkElements_2024(rdapResponseData, results, config));
        validations.add(new ResponseValidation2Dot7Dot2_2024(config, queryType, rdapResponseData, results));
        validations.add(new ResponseValidation2Dot7Dot4Dot1_2024(rdapResponseData, results, config));
        validations.add(new ResponseValidation2Dot7Dot4Dot2_2024(rdapResponseData, results, config));
        validations.add(new ResponseValidation2Dot7Dot4Dot3_2024(rdapResponseData, results, config));
        validations.add(new ResponseValidation2Dot7Dot4Dot4_2024(rdapResponseData, results, config));
        validations.add(new ResponseValidation2Dot7Dot4Dot6_2024(rdapResponseData, results, config));
        validations.add(new ResponseValidation2Dot7Dot4Dot8_2024(rdapResponseData, results, config));
        validations.add(new ResponseValidation2Dot7Dot4Dot9_2024(rdapResponseData, results, config));
        validations.add(new ResponseValidationStatusDuplication_2024(rdapResponseData, results, config));
        validations.add(new ResponseValidation2Dot7Dot6Dot1_2024(rdapResponseData, results, config));
        validations.add(new StdRdapConformanceValidation_2024(rdapResponseData, results, config));
        ...
        validations.add(new ResponseValidation2Dot10_2024(rdapResponseData, results, config));
        ...
        if (config.isNetworkEnabled()) {
            ...
            validations.add(new TigValidation1Dot13(rdapResponse, results, config)); // reads HTTP headers
    ...
    private List<ProfileValidation> get2019RdapValidations(HttpResponse<String> rdapResponse,
        ...
        // All validations in original order - exactly like master branch
        validations.add(new TigValidation1Dot14(rdapResponseData, results, config));
        validations.add(new TigValidation3Dot2(rdapResponseData, results, config, queryType));
        validations.add(new TigValidation3Dot3And3Dot4(rdapResponseData, results, config, validator));
        validations.add(new TigValidation4Dot1(rdapResponseData, results, config));
        validations.add(new TigValidation7Dot1And7Dot2(rdapResponseData, results, config));
        validations.add(new ResponseValidation1Dot2Dot2(rdapResponseData, results, config));
        validations.add(new ResponseValidation1Dot3(rdapResponseData, results, config));
        validations.add(new ResponseValidation1Dot4(rdapResponseData, results, config));
        validations.add(new ResponseValidationLastUpdateEvent(rdapResponseData, results, config, queryType));
        validations.add(new ResponseValidation2Dot1(rdapResponseData, results, config, queryType));
        ...
        validations.add(new ResponseValidation2Dot3Dot1Dot1(rdapResponseData, results, config, queryType));
        validations.add(new ResponseValidation2Dot3Dot1Dot2(rdapResponseData, results, config, queryType));
        validations.add(new ResponseValidationNoticesIncluded(rdapResponseData, results, config, queryType));

...
public class TigValidation1Dot14 extends RDAPConformanceValidation {
  ...
  public TigValidation1Dot14(String rdapResponse, RDAPValidatorResults results, RDAPValidatorConfiguration config) {
    super(rdapResponse, results, config,"icann_rdap_technical_implementation_guide_0", -20600,

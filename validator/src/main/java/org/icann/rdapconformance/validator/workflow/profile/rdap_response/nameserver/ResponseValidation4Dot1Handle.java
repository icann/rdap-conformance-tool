...
public final class ResponseValidation4Dot1Handle extends HandleValidation {
  ...
  public ResponseValidation4Dot1Handle(QueryContext qctx) {

    // Error code: -49102 (handle format validation)
    // Note: -49103 (EPPROID validation) is generated by HandleValidation base class
    super(qctx.getConfig(), qctx.getRdapResponseData(), qctx.getResults(), qctx.getDatasetService(), qctx.getQueryType(), -49102, "nameserver");
  }

...
public class ResponseValidation2Dot4Dot1Test extends ResponseDomainValidationTestBase {
  ...
  public ProfileValidation getProfileValidation() {
    ...
    return new ResponseValidation2Dot4Dot1(domainContext);
  }
  ...
  public void testDoLaunch() {
    ...
    assertThat(new ResponseValidation2Dot4Dot1(helpContext).doLaunch()).isFalse();
    ...
    assertThat(new ResponseValidation2Dot4Dot1(nameserversContext).doLaunch()).isFalse();
    ...
    assertThat(new ResponseValidation2Dot4Dot1(nameserverContext).doLaunch()).isFalse();
    ...
    assertThat(new ResponseValidation2Dot4Dot1(entityContext).doLaunch()).isFalse();
    ...
    domainContext.setRdapResponseData(queryContext.getRdapResponseData());
    assertThat(new ResponseValidation2Dot4Dot1(domainContext).doLaunch()).isTrue();
  }

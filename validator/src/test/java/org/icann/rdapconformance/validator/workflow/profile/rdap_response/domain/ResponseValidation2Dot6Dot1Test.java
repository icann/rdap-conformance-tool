...
public class ResponseValidation2Dot6Dot1Test extends ResponseDomainValidationTestBase {
  ...
  public void testDoLaunch() {
    ...
    assertThat(new ResponseValidation2Dot6Dot1(helpContext).doLaunch()).isFalse();
    ...
    assertThat(new ResponseValidation2Dot6Dot1(nameserversContext).doLaunch()).isFalse();
    ...
    assertThat(new ResponseValidation2Dot6Dot1(nameserverContext).doLaunch()).isFalse();
    ...
    assertThat(new ResponseValidation2Dot6Dot1(entityContext).doLaunch()).isFalse();
    ...
    domainContext.setRdapResponseData(queryContext.getRdapResponseData());
    assertThat(new ResponseValidation2Dot6Dot1(domainContext).doLaunch()).isTrue();
  }
